...
switch lower(BME.Gatings.Type)
    case 'mtl'
        ...
        Grad = BME.Gatings.Alpha*BME.Gatings.Input'*Grad / N;
        NewGatingWeight = GatingWeight - Grad;


% 
%         while norm(NewGatingWeight - GatingWeight)/norm(NewGatingWeight) < MinWeightChange
%             Grad = Grad*10;
%             NewGatingWeight = GatingWeight - Grad;
%         end
